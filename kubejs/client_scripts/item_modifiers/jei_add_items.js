onEvent('jei.add.items', (event) => {
    const items = [
        ...
        Item.of('tconstruct:crafting_station', { texture: 'minecraft:oak_planks' }),
        Item.of('tconstruct:part_builder', { texture: 'minecraft:oak_planks' }),
        Item.of('tconstruct:scorched_anvil', { texture: 'emendatusenigmatica:steel_block' }),
        Item.of('tconstruct:tinkers_anvil', { texture: 'emendatusenigmatica:steel_block' }),
        'lootr:lootr_chest',
        'lootr:lootr_barrel',
