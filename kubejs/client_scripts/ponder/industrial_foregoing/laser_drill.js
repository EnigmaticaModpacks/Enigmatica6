...
onEvent('ponder.tag', (event) => {
  event.add('enigmatica6:industrial_foregoing', [
...
onEvent('ponder.registry', (event) => {
  ...
  event
    .create('enigmatica6:laser_drill', [
      'industrialforegoing:ore_laser_base',
      'industrialforegoing:fluid_laser_base',
      'industrialforegoing:laser_drill',
    ...
    //.tag('enigmatica6:industrial_foregoing')
    .scene(
      'introduction',
      'How to use the Laser Drill',
      'enigmatica6:industrial_foregoing/laser_drill/example_setup',
      (scene, util) => {
        scene.showBasePlate();
        ...
        scene
          .world()
          .hideSection(
            util.select().everywhere().substract(util.select().layer(0)).substract(util.select().position(3, 3, 3)),
            Facing.down
          );
        ...
        scene
          .overlay()
          .chaseBoundingBoxOutline(PonderPalette.GREEN, hintBox, AABB.of(3.25, 3.25, 3.25, 3.75, 3.75, 3.75), 2);
    ...
    .scene(
      ...
      (scene, util) => {
        ...
        scene
          ...
          .colored(PonderPalette.GREEN)
          .text(`For example, if we wanted more Uranium or Emerald Ore, we could add a lime lens to the Laser...`)
          .independent(20);
        ...
        scene
          ...
          .showControls(
            new PonderInput([3.5, 4, 3.5], PonderPointing.DOWN)
              ...
              .withItem(
                randomOf(Ingredient.of(['#forge:ores/uranium', '#forge:ores/emerald']).filter('#forge:chunks'))
              ),
            120
          );
    ...
    .scene(
      ...
      (scene, util) => {
        ...
        scene
          ...
          .showText(60)
          .colored(PonderPalette.INPUT)
          .text('In addition to increasing your odds with the Ore Laser, Lenses serve another important purpose:')
          .independent(30);
        ...
        scene
          .overlay()
          .chaseBoundingBoxOutline(PonderPalette.GREEN, fluidHint, AABB.of(3.25, 3.25, 3.25, 3.75, 3.75, 3.75), 10);
        ...
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.OUTPUT, fluidHint, AABB.of(3, 4, 3, 4, 5, 4), 120);
    ...
    .scene(
      'ether_gas',
      'Getting Ether Gas',
      'enigmatica6:industrial_foregoing/laser_drill/wither_milker',
      (scene, util) => {
        scene.showBasePlate();
        ...
        scene
          .overlay()
          .chaseBoundingBoxOutline(PonderPalette.GREEN, layerHint, AABB.of(3.25, 6.25, 3.25, 3.75, 6.75, 3.75), 10);
        ...
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.GREEN, layerHint, AABB.of(3, 1, 3, 4, 2, 4), stasisTime);

        let stasisHint = new Object();
        scene
          .overlay()
          .chaseBoundingBoxOutline(PonderPalette.BLUE, stasisHint, AABB.of(3.25, 1.25, 3.25, 3.75, 1.75, 3.75), 5);
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.BLUE, stasisHint, AABB.of(2, 2, 2, 5, 5, 5), stasisTime);
