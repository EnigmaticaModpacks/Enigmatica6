    ...
    event
      ...
      .scene(
        ...
        (scene, util) => {
            ...
            .text(`Want to search the deep dark Undergarden? Build a nether portal like structure with Stone Bricks.`)
            .independent(60);
            ...
            scene.world().setBlocks(util.select().fromTo(2, 2, 3, 4, 4, 3), util.getDefaultState('undergarden:undergarden_portal'), true);
