...
onEvent('recipes', (event) => {
    ...
    dyeSources.forEach((recipe) => {
        botania_dye_pestle_mortar(recipe, id_prefix);
        create_dye_milling(recipe, id_prefix);
        ars_nouveau_dye_crushing(recipe, id_prefix);
        immersiveengineering_dye_crusher(recipe, id_prefix);
        //integrateddynamics_dye_squeezing(recipe, id_prefix);
        mekanism_dye_enriching(recipe, id_prefix);
        mekanism_pigment_extracting(recipe, id_prefix);
        pedestals_dye_crushing(recipe, id_prefix);
        thermal_dye_centrifuge(recipe, id_prefix);
        atum_quern_milling(recipe, id_prefix);
        shapeless_dye_crafting(recipe, id_prefix);
        occultism_dye_crushing(recipe, id_prefix);
    });

    //dye normalization functions
    function botania_dye_pestle_mortar(recipe, id_prefix) {
    ...
    function create_dye_milling(recipe, id_prefix) {
        var baseCount = 2,
            multiplier = 1;
        if (recipe.type == 'large') {
            multiplier = 2;
    ...
    function ars_nouveau_dye_crushing(recipe, id_prefix) {
        var baseCount = 2,
            multiplier = 1;
        if (recipe.type == 'large') {
            multiplier = 2;
    ...
    function immersiveengineering_dye_crusher(recipe, id_prefix) {
        var baseCount = 2,
            multiplier = 1;
        if (recipe.type == 'large') {
            multiplier = 2;
    ...
    // function integrateddynamics_dye_squeezing(recipe, id_prefix) {
    //     var baseCount = 2,
    //         multiplier = 1;
    ...
    function mekanism_dye_enriching(recipe, id_prefix) {
        var baseCount = 3,
            multiplier = 1;
        if (recipe.type == 'large') {
            multiplier = 2;
    ...
    function mekanism_pigment_extracting(recipe, id_prefix) {
    ...
    function pedestals_dye_crushing(recipe, id_prefix) {
        if (recipe.input == 'minecraft:bone') {
            return;
        }
    ...
    function thermal_dye_centrifuge(recipe, id_prefix) {
        if (recipe.input == 'minecraft:bone') {
            return;
        }
    ...
    function atum_quern_milling(recipe, id_prefix) {
        var baseCount = 4,
            multiplier = 1;
        if (recipe.type == 'large') {
            multiplier = 2;
    ...
    function shapeless_dye_crafting(recipe, id_prefix) {
    ...
    function occultism_dye_crushing(recipe, id_prefix) {
        if (recipe.input == 'minecraft:bone') {
            return;
        }
