events.listen("recipes", function (event) {
  ...
  for (var i = 0; i < colors.length; i++) {
    ...
    event.shapeless(
      { item: "minecraft:" + colors[i] + "_concrete_powder", count: 8 },
      [dyeTag, sand, sand, sand, sand, gravel, gravel, gravel, gravel]
    );
    ...
    event.shaped(
      { item: "minecraft:" + colors[i] + "_carpet", count: 3 },
      ["WW"],
      {
        W: wool,
      }
    ...
    event.shaped(
      { item: "minecraft:" + colors[i] + "_stained_glass_pane", count: 8 },
      ["GGG", "GDG", "GGG"],
      {
        G: glass_pane,
        D: dyeTag,
    ...
    event.shaped(
      { item: "minecraft:" + colors[i] + "_stained_glass", count: 8 },
      ["GGG", "GDG", "GGG"],
      {
        G: glass,
        D: dyeTag,
  ...
  event.replaceInput(
    { mod: "buildinggadgets" },
    "#forge:ingots/iron",
    "#forge:ingots/iron_aluminum"
  );
  event.replaceInput(
    { mod: "powah" },
    "#forge:ingots/iron",
    "#forge:ingots/iron_copper"
  );
  event.replaceInput(
    { mod: "powah" },
    "#forge:nuggets/iron",
    "#forge:nuggets/iron_copper"
  );
