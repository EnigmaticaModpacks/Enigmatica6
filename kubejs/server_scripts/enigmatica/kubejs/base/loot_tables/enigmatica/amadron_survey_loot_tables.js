onEvent('server.datapack.low_priority', (event) => {
    let lootTables = [
        ...
        },
        {
            ...
            rolls: [16, 32],
            entries: [
                { amount: [16, 24], weight: 1, item: 'emendatusenigmatica:bitumen_chunk' },
                { amount: [16, 24], weight: 2, item: 'emendatusenigmatica:coal_chunk' },
                { amount: [16, 24], weight: 3, item: 'emendatusenigmatica:diamond_chunk' },
                { amount: [16, 24], weight: 4, item: 'emendatusenigmatica:emerald_chunk' },
                { amount: [16, 24], weight: 2, item: 'emendatusenigmatica:fluorite_chunk' },
                { amount: [16, 24], weight: 4, item: 'emendatusenigmatica:lapis_chunk' },
                { amount: [16, 24], weight: 3, item: 'emendatusenigmatica:potassium_nitrate_chunk' },
                { amount: [16, 24], weight: 4, item: 'emendatusenigmatica:redstone_chunk' },

                { amount: [16, 24], weight: 5, item: 'emendatusenigmatica:aluminum_chunk' },
                { amount: [16, 24], weight: 10, item: 'emendatusenigmatica:copper_chunk' },
                { amount: [16, 24], weight: 6, item: 'emendatusenigmatica:gold_chunk' },
                { amount: [16, 24], weight: 11, item: 'emendatusenigmatica:iron_chunk' },
                { amount: [16, 24], weight: 6, item: 'emendatusenigmatica:lead_chunk' },
                { amount: [16, 24], weight: 4, item: 'emendatusenigmatica:nickel_chunk' },
                { amount: [16, 24], weight: 8, item: 'emendatusenigmatica:osmium_chunk' },
                { amount: [16, 24], weight: 5, item: 'emendatusenigmatica:silver_chunk' },
                { amount: [16, 24], weight: 8, item: 'emendatusenigmatica:tin_chunk' },
                { amount: [16, 24], weight: 5, item: 'emendatusenigmatica:uranium_chunk' },
                { amount: [16, 24], weight: 4, item: 'emendatusenigmatica:zinc_chunk' },

                { amount: [16, 24], weight: 4, item: 'atum:nebu_ore' },
                { amount: [16, 24], weight: 2, item: 'atum:relic_ore' },
                { amount: [32, 64], weight: 15, item: 'atum:sand' },
                { amount: [16, 24], weight: 6, item: 'atum:marl' }
            ]
        },
        {
            ...
            entries: [
                ...
                { amount: [16, 24], weight: 6, item: 'undergarden:regalium_ore' },
                { amount: [16, 24], weight: 6, item: 'undergarden:utherium_ore' },
                { amount: [16, 24], weight: 8, item: 'undergarden:froststeel_ore' },
                { amount: [16, 24], weight: 10, item: 'undergarden:cloggrum_ore' }
            ]
        },
        {
