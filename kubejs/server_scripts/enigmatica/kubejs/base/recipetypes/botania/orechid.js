events.listen('server.datapack.low_priority', (event) => {
    var data = {
        recipes: [
            ...
            { result: 'emendatusenigmatica:bitumen_ore', weight: 1000 },
            { result: 'emendatusenigmatica:cinnabar_ore', weight: 2585 },
            { result: 'emendatusenigmatica:coal_ore', weight: 5000 },
            ...
            { result: 'emendatusenigmatica:iron_ore', weight: 3000 },
