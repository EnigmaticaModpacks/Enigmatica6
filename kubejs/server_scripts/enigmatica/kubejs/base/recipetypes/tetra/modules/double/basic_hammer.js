onEvent('server.datapack.low_priority', (event) => {
    const json = {
        ...
        variants: [
            {
                materials: ['tetra:metal/starmetal'],
                key: 'basic_hammer/',
                attributes: {
                ...
                extract: {
                    ...
                    models: [
                        {
                            location: 'tetra:items/module/double/head/basic_hammer/'
                        }
                    ]
                }
            },
            {
                materials: ['tetra:metal/sky'],
                key: 'basic_hammer/',
                attributes: {
                    'generic.attack_speed': -1.1
                },
            ...
            {
                materials: ['tetra:metal/alfsteel'],
                key: 'basic_hammer/',
                attributes: {
                    'generic.attack_speed': -1.1
                },
    ...
    event.addJson(`tetra:modules/double/basic_hammer.json`, json);
});
