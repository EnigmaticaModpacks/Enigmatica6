events.listen('recipes', (event) => {
    var data = {
        recipes: [
			...
			{input: 'simplefarming:cantaloupe_seeds', fluid: 'immersiveengineering:plantoil', amount: 20, energy: 6400},
			...
			{input: 'simplefarming:sweet_potato_seeds', fluid: 'immersiveengineering:plantoil', amount: 60, energy: 6400},
			...
			{input: 'simplefarming:sunflower_seeds', fluid: 'immersiveengineering:plantoil', amount: 80, energy: 6400},
