...
const stonecuttables = [
    ...
    },
    {
        ...
        stones: [
            ...
            'chipped:glowstone_2',
            'chipped:glowstone_1',
			'chisel:glowstone/cracked',
			'chisel:glowstone/solid_bricks',
			'chisel:glowstone/small_bricks',
			'chisel:glowstone/soft_bricks',
			'chisel:glowstone/cracked_bricks',
			'chisel:glowstone/triple_bricks',
			'chisel:glowstone/encased_bricks',
			'chisel:glowstone/array',
			'chisel:glowstone/tiles_medium',
			'chisel:glowstone/tiles_large',
			'chisel:glowstone/tiles_small',
			'chisel:glowstone/chaotic_medium',
			'chisel:glowstone/chaotic_small',
			'chisel:glowstone/braid',
			'chisel:glowstone/dent',
			'chisel:glowstone/french_1',
			'chisel:glowstone/french_2',
			'chisel:glowstone/jellybean',
			'chisel:glowstone/layers',
			'chisel:glowstone/mosaic',
			'chisel:glowstone/ornate',
			'chisel:glowstone/panel',
			'chisel:glowstone/road',
			'chisel:glowstone/slanted',
			'chisel:glowstone/circular',
			'chisel:glowstone/pillar',
			'chisel:glowstone/twisted',
			'chisel:glowstone/prism',
			'chisel:glowstone/extra/bismuth',
			'chisel:glowstone/extra/tiles_large_bismuth',
			'chisel:glowstone/extra/tiles_medium_bismuth',
			'chisel:glowstone/extra/neon',
			'chisel:glowstone/extra/neon_panel'
        ],
        onlyAsOutput: [],
        onlyAsInput: []
    },
...
let chiselStoneTypes = ["cracked","solid_bricks","small_bricks","soft_bricks","cracked_bricks","triple_bricks","encased_bricks","chaotic_bricks","array","tiles_medium","tiles_large","tiles_small","chaotic_medium","chaotic_small","braid","dent","french_1","french_2","jellybean","layers","mosaic","ornate","panel","road","slanted","zag","circular","circularct","weaver","pillar","twisted","prism","cuts"];
colors.forEach((color) => { // @Chisel concrete
	let stonecuttablesIndex = stonecuttables.findIndex((obj) => {return obj.name == `${color}_concrete`;});
