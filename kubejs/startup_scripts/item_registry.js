onEvent('item.registry', (event) => {
    ...
    const bees = [
        ...
        {name: 'aluminum',       color: 0xdce6f7},
        {name: 'blaze',          color: 0xfff32d},
        {name: 'boobee',         color: 0xe9f3ea},
        {name: 'brass',          color: 0x998d38},
        {name: 'bronze',         color: 0xd38c53},
        {name: 'catnip',         color: 0xeaa939},
        {name: 'clay',           color: 0xacaebd},
        {name: 'coal',           color: 0x303030},
        {name: 'constantan',     color: 0xd8876b},
        {name: 'copper',         color: 0xbb5b30},
        {name: 'creeper',        color: 0x0c9f0a},
        {name: 'diamond',        color: 0x00ffff},
        {name: 'electrum',       color: 0xe5b840},
        {name: 'emerald',        color: 0x18eb09},
        {name: 'ender',          color: 0x339786},
        {name: 'enderium',       color: 0x0a4a4a},
        {name: 'ghast',          color: 0xfaebd7},
        {name: 'glowstone',      color: 0xffbc5e},
        {name: 'gold',           color: 0xffdc00},
        {name: 'gravel',         color: 0x968e8e},
        {name: 'icy',            color: 0x92b9fe},
        {name: 'invar',          color: 0xdfe5e2},
        {name: 'iron',           color: 0xffcc99},
        {name: 'lapis',          color: 0x345ec3},
        {name: 'lead',           color: 0x333952},
        {name: 'lumium',         color: 0xe5f3b5},
        {name: 'netherite',      color: 0x654740},
        {name: 'nether_quartz',  color: 0xd4caba},
        {name: 'nickel',         color: 0x8c8f86},
        {name: 'obsidian',       color: 0x663399},
        {name: 'osmium',         color: 0xc1e0e7},
        {name: 'pigman',         color: 0x885956},
        {name: 'redstone',       color: 0xaa0f01},
        {name: 'rgbee',          color: 0xffffff},
        {name: 'sand',           color: 0xe7e4bb},
        {name: 'signalum',       color: 0xfd641a},
        {name: 'silver',         color: 0xc5d1fe},
        {name: 'skeleton',       color: 0xf6f2e6},
        {name: 'slimy',          color: 0x73c262},
        {name: 'steel',          color: 0x858585},
        {name: 'tin',            color: 0x7d81a4},
        {name: 'uranium',        color: 0x333c2f},
        {name: 'water',          color: 0x5979ef},
        {name: 'wither',         color: 0x444444},
        {name: 'zinc',           color: 0x818653},
        {name: 'zombie',         color: 0x2f4e32},
        {name: 'forest',         color: 0x4c4c26},
        {name: 'rocky',          color: 0x8f8f8f},
        {name: 'industrious',    color: 0xce7dce},
        {name: 'bloody',         color: 0x80251f},
        {name: 'elven',          color: 0xff66cc},
        {name: 'infused',        color: 0x1bb373},
        {name: 'mana',           color: 0x4c97ff},
        {name: 'sky',            color: 0x73d0ff},
        {name: 'starry',         color: 0x002184},
        {name: 'tainted',        color: 0xcc6d3d},
        {name: 'terrestrial',    color: 0x5bf23d},
        {name: 'enderslime',     color: 0xa777e1},
        {name: 'ichor',          color: 0xf7731f},
        {name: 'skyslime',       color: 0x4ab1a4},
        {name: 'cobalt',         color: 0x20adc9},
        {name: 'soup',           color: 0x8b7173},
        {name: 'clockwork',      color: 0x70522e},
        {name: 'spelling',       color: 0x905e43},
        {name: 'wasabee',        color: 0x59a523},
        {name: 'basalz',         color: 0x1b141d},
        {name: 'blitz',          color: 0xdef7fa},
        {name: 'blizz',          color: 0x37b7fe},
        {name: 'direbee20',      color: 0x859292},
        {name: 'generikbee',     color: 0xf25843},
        {name: 'otherworldly',   color: 0x1d1d24},
        {name: 'carbee',         color: 0xe39c27},
        {name: 'dusty_mummbee',  color: 0xe7e4bb},
        {name: 'brutish_zombee', color: 0x2f4e32},
        {name: 'shepherd',       color: 0x945c45},
        {name: 'clogged',        color: 0xba9d7b},
        {name: 'regal',          color: 0xebbe76},
        {name: 'frosty',         color: 0xb9d3ec},
        {name: 'starry_lexxie',  color: 0xffa500},
        {name: 'kitten',         color: 0xeaa939},
        {name: 'oreo',           color: 0x442920},
        {name: 'yeti',           color: 0xe9f4f6},
        {name: 'abbee',          color: 0xe5ded5},
    ];
    ...
    bees.forEach((bee) => {
        event.create(`${bee.name}_larva`).group(`KubeJS`).texture('kubejs:item/bee_larva').parentModel('kubejs:item/bee_larva').color(1, bee.color);
    });
