...
_Using Forge-1.16.5-36.2.34_ | No mod update list this time | _[Modlist](https://github.com/NillerMedDild/Enigmatica6/blob/master/changelogs/modlist_1.3.0.md)_
...
- Use :menril\_logs tag provided by `ID` for ultimine [\#4859](https://github.com/EnigmaticaModpacks/Enigmatica6/pull/4859) ([Quezler](https://github.com/Quezler))
...
-   Missing valid_apiaries tag list. [\#3384](https://github.com/NillerMedDild/Enigmatica6/issues/3384)
...
-   Bee Crafting - move to Jarred Bees [\#3012](https://github.com/NillerMedDild/Enigmatica6/pull/3012) ([TemperedFool](https://github.com/TemperedFool))
-   Blackstone from Cobblegens [\#2989](https://github.com/NillerMedDild/Enigmatica6/issues/2989)
-   Change the order of the mycelial generator quests [\#2985](https://github.com/NillerMedDild/Enigmatica6/issues/2985)
-   Fire hurts when put out [\#3023](https://github.com/NillerMedDild/Enigmatica6/issues/3023)
-   Higher Turtle Spawn Chance [\#3000](https://github.com/NillerMedDild/Enigmatica6/issues/3000)
-   Update RBees Quests [\#3026](https://github.com/NillerMedDild/Enigmatica6/pull/3026) ([TemperedFool](https://github.com/TemperedFool))
...
-   Add a dark purple tooltip to wither immune blocks [\#2788](https://github.com/NillerMedDild/Enigmatica6/pull/2788) ([MuteTiefling](https://github.com/MuteTiefling))
-   Added Pink Slime from the Pink Wither in the Fluid Laser Drill [\#2821](https://github.com/NillerMedDild/Enigmatica6/pull/2821) ([Buuz135](https://github.com/Buuz135))
-   Add EE and KJS fluids to Create Pump Blacklist [\#2809](https://github.com/NillerMedDild/Enigmatica6/pull/2809) ([MuteTiefling](https://github.com/MuteTiefling))
-   Add Infinity Launcher recipe and quest! [\#2819](https://github.com/NillerMedDild/Enigmatica6/pull/2819) ([MuteTiefling](https://github.com/MuteTiefling))
-   Add Infinity Nuke nucleosynthesis recipe. Watch out! [\#2818](https://github.com/NillerMedDild/Enigmatica6/pull/2818) ([MuteTiefling](https://github.com/MuteTiefling))
-   Add more fun loot to Towers of the Wild [\#2829](https://github.com/NillerMedDild/Enigmatica6/pull/2829) ([MuteTiefling](https://github.com/MuteTiefling))
-   Add proper tags to Archwood Button [\#2783](https://github.com/NillerMedDild/Enigmatica6/pull/2783) ([MuteTiefling](https://github.com/MuteTiefling))
-   Allow Aquaculture Neptunium items to be recycled into Neptunium nuggets, 1 nugget per ingot used to craft the item
-   \[0.5.6\] Astral's Marble Pillar [\#2800](https://github.com/NillerMedDild/Enigmatica6/issues/2800)
-   \[Expert\] Early game utility tweaks and some shuffling of items to keep them available at relevant progression points [\#2799](https://github.com/NillerMedDild/Enigmatica6/pull/2799) ([MuteTiefling](https://github.com/MuteTiefling))
-   Boobee Spawn Egg Name [\#2756](https://github.com/NillerMedDild/Enigmatica6/pull/2756) ([TemperedFool](https://github.com/TemperedFool))
-   Correctly expand Create and IE sawing [\#2779](https://github.com/NillerMedDild/Enigmatica6/pull/2779) ([MuteTiefling](https://github.com/MuteTiefling))
-   Disabled JourneyMap Waystone Compatibility, as some people found it annoying.
-   fixes occultism quest progression issues, removed chalk from rewards [\#2751](https://github.com/NillerMedDild/Enigmatica6/pull/2751) ([theboo](https://github.com/theboo))
-   Fix for some workbenches not being seen as workbenches. [\#2784](https://github.com/NillerMedDild/Enigmatica6/pull/2784) ([MuteTiefling](https://github.com/MuteTiefling))
-   Fix Nether Wart Outputs from IE Crusher and BM Alchemy [\#2782](https://github.com/NillerMedDild/Enigmatica6/pull/2782) ([MuteTiefling](https://github.com/MuteTiefling))
-   Fix Tetra Geodes again? [\#2780](https://github.com/NillerMedDild/Enigmatica6/pull/2780) ([MuteTiefling](https://github.com/MuteTiefling))
-   ftbchunks-server configs incorrect. [\#2728](https://github.com/NillerMedDild/Enigmatica6/issues/2728)
-   Implement crushing multiplier blacklist to prevent dupes, expand Occultism Crushing compat [\#2805](https://github.com/NillerMedDild/Enigmatica6/pull/2805) ([MuteTiefling](https://github.com/MuteTiefling))
-   Industrious & Thermal Bees \(and other updates\) [\#2803](https://github.com/NillerMedDild/Enigmatica6/pull/2803) ([TemperedFool](https://github.com/TemperedFool))
-   Invar Ingot Mechanical Mixer [\#2765](https://github.com/NillerMedDild/Enigmatica6/issues/2765)
-   Make Post Box craftable earlier [\#2719](https://github.com/NillerMedDild/Enigmatica6/pull/2719) ([MuteTiefling](https://github.com/MuteTiefling))
-   Mekanism Quest updates: Add info about tag filters to Digital Miner [\#2750](https://github.com/NillerMedDild/Enigmatica6/pull/2750) ([MuteTiefling](https://github.com/MuteTiefling))
-   More Typos [\#2757](https://github.com/NillerMedDild/Enigmatica6/pull/2757) ([TemperedFool](https://github.com/TemperedFool))
-   Nature's Aura Ritual of the Forest Recipe Overhaul [\#2816](https://github.com/NillerMedDild/Enigmatica6/pull/2816) ([MuteTiefling](https://github.com/MuteTiefling))
-   Re-add ingot to alloy heated mixing [\#2787](https://github.com/NillerMedDild/Enigmatica6/pull/2787) ([MuteTiefling](https://github.com/MuteTiefling))
-   Remove Snow \> Dense snow in Pressure Chamber [\#2797](https://github.com/NillerMedDild/Enigmatica6/pull/2797) ([MuteTiefling](https://github.com/MuteTiefling))
-   Resourceful Bee Quest Updates [\#2830](https://github.com/NillerMedDild/Enigmatica6/pull/2830) ([TemperedFool](https://github.com/TemperedFool))
-   Special Bees spawn chance increase [\#2722](https://github.com/NillerMedDild/Enigmatica6/pull/2722) ([Ridanisaurus](https://github.com/Ridanisaurus))
-   SushiGo Crafting crops should be usable in other recipes [\#2826](https://github.com/NillerMedDild/Enigmatica6/issues/2826)
-   Update title to Interfaces quest [\#2802](https://github.com/NillerMedDild/Enigmatica6/pull/2802) ([MuteTiefling](https://github.com/MuteTiefling))
-   Wasabee Implementation [\#2753](https://github.com/NillerMedDild/Enigmatica6/pull/2753) ([TemperedFool](https://github.com/TemperedFool))
...
_Using Forge-1.16.5-36.1.31_ | _[Mod Updates](https://github.com/NillerMedDild/Enigmatica6/blob/master/changelogs/changelog_mods_0.5.5.md)_ | _[Modlist](https://github.com/NillerMedDild/Enigmatica6/blob/master/changelogs/modlist_0.5.5md)_
...
-   Added TiCon Copper and Cobalt to the hideRegex [\#2637](https://github.com/NillerMedDild/Enigmatica6/pull/2637) ([Ridanisaurus](https://github.com/Ridanisaurus))
-   Add Glowcane to Market [\#2673](https://github.com/NillerMedDild/Enigmatica6/pull/2673) ([MuteTiefling](https://github.com/MuteTiefling))
-   Add Minecraft Honey Block to T4 Hive/T1 Apiary [\#2629](https://github.com/NillerMedDild/Enigmatica6/pull/2629) ([TemperedFool](https://github.com/TemperedFool))
-   Adjustments to Miner's Delight rewards, Structure changes to Create quests [\#2701](https://github.com/NillerMedDild/Enigmatica6/pull/2701) ([MuteTiefling](https://github.com/MuteTiefling))
-   Alternate PNC Recipes: Elevator Frames and Canon Barrels [\#2687](https://github.com/NillerMedDild/Enigmatica6/pull/2687) ([MuteTiefling](https://github.com/MuteTiefling))
-   \[0.5.3\] Armored Jetpack nerf [\#2623](https://github.com/NillerMedDild/Enigmatica6/issues/2623)
-   Blacklist tinker's construct from supplementaries wall lantern support [\#2675](https://github.com/NillerMedDild/Enigmatica6/pull/2675) ([MuteTiefling](https://github.com/MuteTiefling))
-   Changed Dissolution chamber power/t to default [\#2640](https://github.com/NillerMedDild/Enigmatica6/pull/2640) ([Buuz135](https://github.com/Buuz135))
-   Change the Interactio logs-\>driftwood fluid recipe [\#2669](https://github.com/NillerMedDild/Enigmatica6/issues/2669)
-   Cleanup curios inventory [\#2646](https://github.com/NillerMedDild/Enigmatica6/pull/2646) ([ochotonida](https://github.com/ochotonida))
-   Craft marble and limestone from the Chisel mod using other variations [\#2694](https://github.com/NillerMedDild/Enigmatica6/issues/2694)
-   Create Initial Blacklist for Drygmies - Blacklisting mobs already disallowed in other spawners [\#2682](https://github.com/NillerMedDild/Enigmatica6/pull/2682) ([MuteTiefling](https://github.com/MuteTiefling))
-   Eidolon: clarify the need to find a witch and not a swamp in the first quest [\#2663](https://github.com/NillerMedDild/Enigmatica6/pull/2663) ([Larandar](https://github.com/Larandar))
-   Fix Create Recipe Conflict for Crushed End Stone [\#2678](https://github.com/NillerMedDild/Enigmatica6/pull/2678) ([MuteTiefling](https://github.com/MuteTiefling))
-   Fix Sawdust recipes for Sawdust flooring and block [\#2665](https://github.com/NillerMedDild/Enigmatica6/pull/2665) ([MuteTiefling](https://github.com/MuteTiefling))
-   General Quest Updates: Mekanism and Ars Nouveau [\#2671](https://github.com/NillerMedDild/Enigmatica6/pull/2671) ([MuteTiefling](https://github.com/MuteTiefling))
-   Glowcane [\#2650](https://github.com/NillerMedDild/Enigmatica6/issues/2650)
-   Increase base height of PNC Elevators [\#2676](https://github.com/NillerMedDild/Enigmatica6/pull/2676) ([MuteTiefling](https://github.com/MuteTiefling))
-   Increase mana cost for Drygmy and Sylph production [\#2709](https://github.com/NillerMedDild/Enigmatica6/pull/2709) ([MuteTiefling](https://github.com/MuteTiefling))
-   Interactio Fluid interaction for Driftwood now requires multiple logs to complete. [\#2679](https://github.com/NillerMedDild/Enigmatica6/pull/2679) ([MuteTiefling](https://github.com/MuteTiefling))
-   Make nether ores properly nether only in IF laser drill. Add Cobalt to Dimensional Mineshaft for real this time. [\#2702](https://github.com/NillerMedDild/Enigmatica6/pull/2702) ([MuteTiefling](https://github.com/MuteTiefling))
-   New Bee Textures and Models [\#2710](https://github.com/NillerMedDild/Enigmatica6/pull/2710) ([Ridanisaurus](https://github.com/Ridanisaurus))
-   Placed Dragon Head On Portal Frame After Dragon Death [\#2688](https://github.com/NillerMedDild/Enigmatica6/pull/2688) ([theboo](https://github.com/theboo))
-   Quest Updates: Immersive Engineering [\#2674](https://github.com/NillerMedDild/Enigmatica6/pull/2674) ([MuteTiefling](https://github.com/MuteTiefling))
-   Quest Updates: Mekanism and Loot Tables [\#2672](https://github.com/NillerMedDild/Enigmatica6/pull/2672) ([MuteTiefling](https://github.com/MuteTiefling))
-   Re-Add missing HOP Graphite Ingot Smelt [\#2666](https://github.com/NillerMedDild/Enigmatica6/pull/2666) ([MuteTiefling](https://github.com/MuteTiefling))
-   Recipe to craft sawdust block \[alternate recipe for sawdust flooring\] [\#2654](https://github.com/NillerMedDild/Enigmatica6/issues/2654)
-   Removed end city loot datapack [\#2647](https://github.com/NillerMedDild/Enigmatica6/pull/2647) ([theboo](https://github.com/theboo))
-   Remove trash function from Quark [\#2667](https://github.com/NillerMedDild/Enigmatica6/issues/2667)
-   Some new quest ideas to Mekanism questline [\#2655](https://github.com/NillerMedDild/Enigmatica6/issues/2655)
-   Split Distillation Tower quest [\#2611](https://github.com/NillerMedDild/Enigmatica6/issues/2611)
-   Torchmaster shaped.js [\#2697](https://github.com/NillerMedDild/Enigmatica6/pull/2697) ([TemperedFool](https://github.com/TemperedFool))
-   Unify Tree Fluid Outputs [\#2628](https://github.com/NillerMedDild/Enigmatica6/pull/2628) ([MuteTiefling](https://github.com/MuteTiefling))
-   Update animals.js [\#2644](https://github.com/NillerMedDild/Enigmatica6/pull/2644) ([ochotonida](https://github.com/ochotonida))
-   Updates to Sawing and Crushing - Expanding Occultism, Create, and Immersive Engineering capabilities [\#2664](https://github.com/NillerMedDild/Enigmatica6/pull/2664) ([MuteTiefling](https://github.com/MuteTiefling))

**Bug Fixes**

-   "Crouching" when someone teleports [\#1527](https://github.com/NillerMedDild/Enigmatica6/issues/1527)
-   0.4.13 Wither builder bug\[Industrial Foregoing\] [\#2535](https://github.com/NillerMedDild/Enigmatica6/issues/2535)
-   Acacia Log gives 1mb of Latex per operation, only Dark Oak Log listed in Fluid Extractor JEI [\#2621](https://github.com/NillerMedDild/Enigmatica6/issues/2621)
-   Akashic Tome - No Driftwood Bookshelf Recipe [\#2706](https://github.com/NillerMedDild/Enigmatica6/issues/2706)
-   Artifacts being deleted on opening grave [\#2683](https://github.com/NillerMedDild/Enigmatica6/issues/2683)
-   Atum 2 crashing the game [\#2613](https://github.com/NillerMedDild/Enigmatica6/issues/2613)
-   \[0.4.8\] stone slabs and stairs overly eager to be crafted [\#1879](https://github.com/NillerMedDild/Enigmatica6/issues/1879)
-   \[0.5.4\] Duplicate recipes for Create Crushing Wheels [\#2685](https://github.com/NillerMedDild/Enigmatica6/issues/2685)
-   \[0.5.4\] IF Ore Laser gives unprocessable Aquamarine Shale [\#2686](https://github.com/NillerMedDild/Enigmatica6/issues/2686)
-   \[Quark\] Cannot insert seeds into Seed Pouch \(Disabled Seed Pouch\) [\#1565](https://github.com/NillerMedDild/Enigmatica6/issues/1565)
-   Chisel Raw Marble Worldgen [\#2636](https://github.com/NillerMedDild/Enigmatica6/issues/2636)
-   Game crash when using IF recipes in JEC [\#2658](https://github.com/NillerMedDild/Enigmatica6/issues/2658)
-   internal exception io.netty.handler.codec.decoderexception [\#2704](https://github.com/NillerMedDild/Enigmatica6/issues/2704)
-   Lack of JEI info for bees [\#2126](https://github.com/NillerMedDild/Enigmatica6/issues/2126)
-   Livingwood Avatar \(Botania\) isn't working with the rods [\#2638](https://github.com/NillerMedDild/Enigmatica6/issues/2638)
-   Mishandled Death by Enigmatic Graves [\#2614](https://github.com/NillerMedDild/Enigmatica6/issues/2614)
-   Misspelling in Lexica Botania [\#2691](https://github.com/NillerMedDild/Enigmatica6/issues/2691)
-   My POV is not where its supposed to be, it looks like im sneaking when im not. [\#2635](https://github.com/NillerMedDild/Enigmatica6/issues/2635)
-   Problems placing torches on walls [\#2692](https://github.com/NillerMedDild/Enigmatica6/issues/2692)
-   PSA - Server Crash with Crusher Demon and Emendatus Enigmatica [\#2661](https://github.com/NillerMedDild/Enigmatica6/issues/2661)
-   Recipe conflict processing end stone in crushing wheels [\#2677](https://github.com/NillerMedDild/Enigmatica6/issues/2677)
-   Regular honey blocks can't upgrade beehive [\#2620](https://github.com/NillerMedDild/Enigmatica6/issues/2620)
-   Sushi go crafting rice tag typo [\#2633](https://github.com/NillerMedDild/Enigmatica6/issues/2633)
-   Tinkers lanterns not functional on walls [\#2584](https://github.com/NillerMedDild/Enigmatica6/issues/2584)
-   U cant smelt Graphitedust [\#2642](https://github.com/NillerMedDild/Enigmatica6/issues/2642)
-   Unused EE Items still showing in JEI [\#2419](https://github.com/NillerMedDild/Enigmatica6/issues/2419)
...
-   Add Cobalt to IF Laser Drill [\#2427](https://github.com/NillerMedDild/Enigmatica6/pull/2427) ([MuteTiefling](https://github.com/MuteTiefling))
-   adds generic bee icon to in-world spawned bees in journeymap [\#2447](https://github.com/NillerMedDild/Enigmatica6/pull/2447) ([theboo](https://github.com/theboo))
-   Add ways to obtain various BYG nether items such as mushrooms [\#2493](https://github.com/NillerMedDild/Enigmatica6/pull/2493) ([MuteTiefling](https://github.com/MuteTiefling))
-   \[Worldgen\] Bigger Beaches [\#2531](https://github.com/NillerMedDild/Enigmatica6/pull/2531) ([yagoplx](https://github.com/yagoplx))
-   \[Worldgen\] Spawn player at world center by default [\#2533](https://github.com/NillerMedDild/Enigmatica6/pull/2533) ([yagoplx](https://github.com/yagoplx))
-   \[Worldgen\] Tweak biome warp for biome transition effect [\#2532](https://github.com/NillerMedDild/Enigmatica6/pull/2532) ([yagoplx](https://github.com/yagoplx))
-   Clarify quest text from Shift+Click to Sneak+Click [\#2505](https://github.com/NillerMedDild/Enigmatica6/pull/2505) ([MuteTiefling](https://github.com/MuteTiefling))
-   Clarify quest text from Shift+Click to Sneak+Click [\#2506](https://github.com/NillerMedDild/Enigmatica6/pull/2506) ([MuteTiefling](https://github.com/MuteTiefling))
-   Double the Output for the Production of D-T Fuel in the Chemical Infuser [\#2525](https://github.com/NillerMedDild/Enigmatica6/issues/2525)
-   Increased Cobalt Ore Spawn Weight
-   Mekanism Fusion Fuel Production Buff [\#2529](https://github.com/NillerMedDild/Enigmatica6/pull/2529) ([MuteTiefling](https://github.com/MuteTiefling))
-   Normalize output quantities for crafting drawers [\#2480](https://github.com/NillerMedDild/Enigmatica6/pull/2480) ([MuteTiefling](https://github.com/MuteTiefling))
-   Phrasing in Tinker's Anvil description [\#2521](https://github.com/NillerMedDild/Enigmatica6/issues/2521)
-   Re-add Ingot/Gem to Dust recipe unification [\#2457](https://github.com/NillerMedDild/Enigmatica6/pull/2457) ([MuteTiefling](https://github.com/MuteTiefling))
-   Reduce default spawn rates for Archwood Forest biome [\#2485](https://github.com/NillerMedDild/Enigmatica6/issues/2485)
-   Replace "shift right click" with "crouch right click" in all quests. [\#2504](https://github.com/NillerMedDild/Enigmatica6/issues/2504)
-   Replace obsolete hammer reward with a potion [\#2434](https://github.com/NillerMedDild/Enigmatica6/pull/2434) ([MuteTiefling](https://github.com/MuteTiefling))
-   Slight Change to MekaSuit Helmet Quest [\#2475](https://github.com/NillerMedDild/Enigmatica6/issues/2475)
-   Update Meka Suite Helm Description to call attention to it's Magic Damage Protection [\#2481](https://github.com/NillerMedDild/Enigmatica6/pull/2481) ([MuteTiefling](https://github.com/MuteTiefling))
-   Update Tinker's Anvil description and allowed blocks [\#2524](https://github.com/NillerMedDild/Enigmatica6/pull/2524) ([MuteTiefling](https://github.com/MuteTiefling))
-   Wither Bone Unification [\#2514](https://github.com/NillerMedDild/Enigmatica6/pull/2514) ([MuteTiefling](https://github.com/MuteTiefling))
...
_Using Forge-1.16.5-36.1.31_ | _[Mod Updates](https://github.com/NillerMedDild/Enigmatica6/blob/master/changelogs/changelog_mods_0.5.0.md)_ | _[Modlist](https://github.com/NillerMedDild/Enigmatica6/blob/master/changelogs/modlist_0.5.0.md)_
...
-   Akashic Tome update [\#2355](https://github.com/NillerMedDild/Enigmatica6/pull/2355) ([MuteTiefling](https://github.com/MuteTiefling))
-   Allow colored honey blocks in tier 4 beehive recipe [\#2380](https://github.com/NillerMedDild/Enigmatica6/issues/2380)
-   Ars Nouveau Quest Updates and Immersive Petroleum Integration [\#2311](https://github.com/NillerMedDild/Enigmatica6/pull/2311) ([MuteTiefling](https://github.com/MuteTiefling))
-   Astral Sorcery - Rock Crystal Ore retexture [\#2322](https://github.com/NillerMedDild/Enigmatica6/pull/2322) ([Ridanisaurus](https://github.com/Ridanisaurus))
-   \[0.4.8\] Better End Stones Stonecutting [\#1911](https://github.com/NillerMedDild/Enigmatica6/issues/1911)
-   \[Enigmatics 6 0.4.14 \] Possible Recipe oversight [\#2347](https://github.com/NillerMedDild/Enigmatica6/issues/2347)
-   BetterEnd stones added to stonecutter [\#2343](https://github.com/NillerMedDild/Enigmatica6/pull/2343) ([MuteTiefling](https://github.com/MuteTiefling))
-   Buff Create Paper recipe [\#2357](https://github.com/NillerMedDild/Enigmatica6/pull/2357) ([MuteTiefling](https://github.com/MuteTiefling))
-   Change Rock Crystal Ore to Rock Crystal Cluster to prevent it feeling out of place in the midst of non-vanilla stone [\#2306](https://github.com/NillerMedDild/Enigmatica6/issues/2306)
-   Clay blocks to clay balls missing recipe? [\#2169](https://github.com/NillerMedDild/Enigmatica6/issues/2169)
-   Create Alchemy Table recipe for Cured Rubber [\#2338](https://github.com/NillerMedDild/Enigmatica6/pull/2338) ([MuteTiefling](https://github.com/MuteTiefling))
-   Create Crafting Table Clay to Clay Ball recipe [\#2318](https://github.com/NillerMedDild/Enigmatica6/pull/2318) ([MuteTiefling](https://github.com/MuteTiefling))
-   Create Windmill Quest - clarify the difference between glue and slime [\#2382](https://github.com/NillerMedDild/Enigmatica6/pull/2382) ([MuteTiefling](https://github.com/MuteTiefling))
-   Disable Loss of Stinger for all Bees [\#2280](https://github.com/NillerMedDild/Enigmatica6/pull/2280) ([MuteTiefling](https://github.com/MuteTiefling))
-   EE 1.2.5 Texture Unification [\#2396](https://github.com/NillerMedDild/Enigmatica6/pull/2396) ([Ridanisaurus](https://github.com/Ridanisaurus))
-   Intro quests for Atum [\#2345](https://github.com/NillerMedDild/Enigmatica6/pull/2345) ([MuteTiefling](https://github.com/MuteTiefling))
-   Latex Unification [\#2320](https://github.com/NillerMedDild/Enigmatica6/pull/2320) ([MuteTiefling](https://github.com/MuteTiefling))
-   More Bee Updates [\#2407](https://github.com/NillerMedDild/Enigmatica6/pull/2407) ([TemperedFool](https://github.com/TemperedFool))
-   More RFTools Spawner Additions [\#2317](https://github.com/NillerMedDild/Enigmatica6/pull/2317) ([MuteTiefling](https://github.com/MuteTiefling))
-   Mountains [\#1638](https://github.com/NillerMedDild/Enigmatica6/issues/1638)
-   On scaling tetra tools and weapons to the end-game and OP-ness of Mekanism tools [\#2301](https://github.com/NillerMedDild/Enigmatica6/issues/2301)
-   Paper rebalance [\#2356](https://github.com/NillerMedDild/Enigmatica6/pull/2356) ([MuteTiefling](https://github.com/MuteTiefling))
-   PP Fluids: Rewrite all recipes [\#2334](https://github.com/NillerMedDild/Enigmatica6/issues/2334)
-   Pretty Fluid Pipes Recipe Thermalization [\#2337](https://github.com/NillerMedDild/Enigmatica6/pull/2337) ([MuteTiefling](https://github.com/MuteTiefling))
-   Quest updates: Mythic Botany and Thermal [\#2277](https://github.com/NillerMedDild/Enigmatica6/issues/2277)
-   Re-enable/fix Compact Machine quests. Add quest to point to Occultism Storage. [\#2367](https://github.com/NillerMedDild/Enigmatica6/pull/2367) ([MuteTiefling](https://github.com/MuteTiefling))
-   Replace FTB Chunks Map with JourneyMap [\#1340](https://github.com/NillerMedDild/Enigmatica6/issues/1340)
-   Revise Ars Nouveau Quests [\#2304](https://github.com/NillerMedDild/Enigmatica6/issues/2304)
-   Set up Create Infinite Fluid blacklist [\#2385](https://github.com/NillerMedDild/Enigmatica6/pull/2385) ([MuteTiefling](https://github.com/MuteTiefling))
-   Trophies for Completing Challenges [\#2412](https://github.com/NillerMedDild/Enigmatica6/issues/2412)
-   Unify rubber & latex [\#1592](https://github.com/NillerMedDild/Enigmatica6/issues/1592)
-   Update Botania and Thermal Quests [\#2290](https://github.com/NillerMedDild/Enigmatica6/pull/2290) ([MuteTiefling](https://github.com/MuteTiefling))
-   Updated biome weights for 0.5.0 [\#2291](https://github.com/NillerMedDild/Enigmatica6/pull/2291) ([theboo](https://github.com/theboo))
-   Update Mob Spawning Blacklists [\#2344](https://github.com/NillerMedDild/Enigmatica6/pull/2344) ([MuteTiefling](https://github.com/MuteTiefling))
-   valid apiary block suggestions [\#2249](https://github.com/NillerMedDild/Enigmatica6/issues/2249)

**Bug Fixes**

-   "Crouching" when someone teleports [\#1527](https://github.com/NillerMedDild/Enigmatica6/issues/1527)
-   Add Hive UpgradeRecipes [\#2342](https://github.com/NillerMedDild/Enigmatica6/pull/2342) ([TemperedFool](https://github.com/TemperedFool))
-   Alex's Mobs Falconry Hood crashes the client upon use. [\#2307](https://github.com/NillerMedDild/Enigmatica6/issues/2307)
-   All slimes have a full-sized hitbox [\#1619](https://github.com/NillerMedDild/Enigmatica6/issues/1619)
-   Apiary Recipe Deletes Bees [\#2303](https://github.com/NillerMedDild/Enigmatica6/issues/2303)
...
-   Astral Sorcery structures doesn't generate in the amplified world type [\#948](https://github.com/NillerMedDild/Enigmatica6/issues/948)
-   Astral structures not generating Lootr chests [\#1412](https://github.com/NillerMedDild/Enigmatica6/issues/1412)
-   \[0.4.8\] Astral Sorcery rock/celestial crystals can be duped with a mekanism cardboard box [\#1847](https://github.com/NillerMedDild/Enigmatica6/issues/1847)
-   \[0.4.9\] Lag spike when crossing claimed chunks while travelling west [\#2077](https://github.com/NillerMedDild/Enigmatica6/issues/2077)
-   \[0.4.14\] Sophisticated Backpacks & Tetra interactions causing crashes [\#2323](https://github.com/NillerMedDild/Enigmatica6/issues/2323)
-   Book o' Enchanting trinket is obtainable but non functional [\#2326](https://github.com/NillerMedDild/Enigmatica6/issues/2326)
-   Bug Carrot Crate Quark spawn in digit dimlet key5 \(RfTOOLS Dimensions\) [\#2305](https://github.com/NillerMedDild/Enigmatica6/issues/2305)
-   Can't copy banners [\#2279](https://github.com/NillerMedDild/Enigmatica6/issues/2279)
-   Create Pewter [\#2399](https://github.com/NillerMedDild/Enigmatica6/issues/2399)
-   Enigmatica 6 0.4.8 - Extra storage crafters loose their name on pickup [\#2035](https://github.com/NillerMedDild/Enigmatica6/issues/2035)
-   Fix Entangled configs not being applied [\#2373](https://github.com/NillerMedDild/Enigmatica6/pull/2373) ([TemperedFool](https://github.com/TemperedFool))
-   Fixes Conflicting Glass Smelting from BYG [\#2349](https://github.com/NillerMedDild/Enigmatica6/pull/2349) ([MuteTiefling](https://github.com/MuteTiefling))
-   Fix server_files/start-server.sh [\#2403](https://github.com/NillerMedDild/Enigmatica6/pull/2403) ([Infinoid](https://github.com/Infinoid))
-   Fix Soupy Bee [\#2379](https://github.com/NillerMedDild/Enigmatica6/pull/2379) ([TemperedFool](https://github.com/TemperedFool))
-   Issue with level-type in Dev version [\#2424](https://github.com/NillerMedDild/Enigmatica6/issues/2424)
-   Minecraft:nether_bricks is missing \#forge:netherbricks tag [\#2432](https://github.com/NillerMedDild/Enigmatica6/issues/2432)
...
-   Separate Prismarine and Prismarine Bricks in Stonecutter [\#2366](https://github.com/NillerMedDild/Enigmatica6/pull/2366) ([MuteTiefling](https://github.com/MuteTiefling))
-   Server crashes upon player joining. [\#2420](https://github.com/NillerMedDild/Enigmatica6/issues/2420)
-   Shrinking device makes x-ray possible [\#2387](https://github.com/NillerMedDild/Enigmatica6/issues/2387)
-   Some Tetra Levels are Unobtainable [\#2143](https://github.com/NillerMedDild/Enigmatica6/issues/2143)
-   T4 Hive/T1 Apiary use all Honey Blocks [\#2381](https://github.com/NillerMedDild/Enigmatica6/pull/2381) ([TemperedFool](https://github.com/TemperedFool))
-   Uraninite Ore through RFtools dimension can't be utilized [\#2292](https://github.com/NillerMedDild/Enigmatica6/issues/2292)
-   Waiting for server [\#2354](https://github.com/NillerMedDild/Enigmatica6/issues/2354)
...
-   Found error in adventuring_time.json and corrected it [\#2223](https://github.com/NillerMedDild/Enigmatica6/pull/2223) ([Sinvoll](https://github.com/Sinvoll))
...
-   A way to make more Faint Amaranth [\#1736](https://github.com/NillerMedDild/Enigmatica6/issues/1736)
-   \[Suggestion\] Disable Jukebox music from mobs with backpacks [\#1973](https://github.com/NillerMedDild/Enigmatica6/issues/1973)
-   \[Suggestion\] recipes for legendary varients of infinity tools [\#1694](https://github.com/NillerMedDild/Enigmatica6/issues/1694)
-   Bee Update Part 3! More balancing and updates to the breeding tree are coming eventually, along with a breeding chart of some sort. [#2000](https://github.com/NillerMedDild/Enigmatica6/pull/2000) [TemperedFool](https://github.com/TemperedFool)
-   Blaze rod -\> powder recipes for mekanism [\#1895](https://github.com/NillerMedDild/Enigmatica6/issues/1895)
...
-   Oddity bush [\#1769](https://github.com/NillerMedDild/Enigmatica6/issues/1769)
-   pneumaticcraft drone and mending tools [\#1918](https://github.com/NillerMedDild/Enigmatica6/issues/1918)
...
-   Quest Suggestion: A quest for mechanical dirt [\#1865](https://github.com/NillerMedDild/Enigmatica6/issues/1865)
-   Quest Update Suggestion: Bee Box [\#1697](https://github.com/NillerMedDild/Enigmatica6/issues/1697)
-   Recipes for Project Vibrant Journey's ground clutter [\#1840](https://github.com/NillerMedDild/Enigmatica6/issues/1840)
...
-   Recipe to re-dye a botany pot [\#1875](https://github.com/NillerMedDild/Enigmatica6/issues/1875)
...
-   Zoology Challenge [\#1797](https://github.com/NillerMedDild/Enigmatica6/issues/1797)
...
-   Ars spells still a little wonky with other mods blocks. This time Resourceful bees with replace spell. [\#1181](https://github.com/NillerMedDild/Enigmatica6/issues/1181)
-   \[0.4.3\] Multiple Ammo Types in minigun causing repeated player kick+ unable to join server [\#1756](https://github.com/NillerMedDild/Enigmatica6/issues/1756)
-   \[0.4.3\] Treated Wood Windows Dupe Bug [\#1793](https://github.com/NillerMedDild/Enigmatica6/issues/1793)
-   \[0.4.5\] Crash when dispensing Tridents from Dispensers [\#1825](https://github.com/NillerMedDild/Enigmatica6/issues/1825)
-   \[0.4.7\] Crafting Combined Pedestal Upgrade Deletes Enchantments [\#1833](https://github.com/NillerMedDild/Enigmatica6/issues/1833)
...
-   \[0.4.8\] Cannot obtain IE Wires [\#1892](https://github.com/NillerMedDild/Enigmatica6/issues/1892)
-   \[0.4.8\] Compact Machines don't have crafting recipies [\#1983](https://github.com/NillerMedDild/Enigmatica6/issues/1983)
-   \[0.4.8\] Crash from beehives and integrated dynamics [\#1883](https://github.com/NillerMedDild/Enigmatica6/issues/1883)
-   \[0.4.8\] Crash when exploring world [\#2014](https://github.com/NillerMedDild/Enigmatica6/issues/2014)
-   \[0.4.8\] Dimentional shard crusher recipes [\#1861](https://github.com/NillerMedDild/Enigmatica6/issues/1861)
-   \[0.4.8\] immersive excavator [\#2021](https://github.com/NillerMedDild/Enigmatica6/issues/2021)
-   \[0.4.8\] Induction Smelter Netherite Ingot Recipe [\#1967](https://github.com/NillerMedDild/Enigmatica6/issues/1967)
...
-   \[0.4.8\] No recipe for refined glowstone in induction smelter [\#1899](https://github.com/NillerMedDild/Enigmatica6/issues/1899)
-   \[0.4.8\] Quick transfer to "Transport" inventory, client freeze. [\#2001](https://github.com/NillerMedDild/Enigmatica6/issues/2001)
...
-   Crash when clicking Show all recipes while in \(ID\) Logic Programmer GUI with JEI [\#1935](https://github.com/NillerMedDild/Enigmatica6/issues/1935)
-   Disabled Wormhole Mirror [\#1854](https://github.com/NillerMedDild/Enigmatica6/issues/1854)
...
-   Graves deleting when dying on top of grave [\#1669](https://github.com/NillerMedDild/Enigmatica6/issues/1669)
-   No Recipe For Sap or Syrup Bottles [\#1906](https://github.com/NillerMedDild/Enigmatica6/issues/1906)
